...
function __promptline {
  ...
  local b_fg="${wrap}38;5;22${end_wrap}"
  local b_bg="${wrap}48;5;42${end_wrap}"
  local b_sep_fg="${wrap}38;5;42${end_wrap}"
  local c_fg="${wrap}38;5;23${end_wrap}"
  local c_bg="${wrap}48;5;156${end_wrap}"
  local c_sep_fg="${wrap}38;5;156${end_wrap}"
  local warn_fg="${wrap}38;5;232${end_wrap}"
  local warn_bg="${wrap}48;5;166${end_wrap}"
  local warn_sep_fg="${wrap}38;5;166${end_wrap}"
  local x_fg="${wrap}38;5;23${end_wrap}"
  local x_bg="${wrap}48;5;156${end_wrap}"
  local x_sep_fg="${wrap}38;5;156${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
